                ...
                <div class="modal-body">
                    <form id="editForm-{{ $input->id }}" method="POST" action="{{ route('inputs.update', ['input' => $input->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Operations" class="form-control" id="editOperations-{{ $input->id }}">
                                <option value="Produksi">Produksi</option>
                                <option value="PM">PM</option>
                                <option value="NOD">NOD</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="Quantity" id="editQuantity-{{ $input->id }}" min="0" step="1" @if($input->Operations != 'Produksi') disabled @endif>
                        </div>
                    </form>
                </div>
